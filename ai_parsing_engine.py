...
Look for common recipe sections such as:
- Ingredients
- Instructions or Steps
- Servings
- Tags

If these fields are present, extract them into structured JSON.
If some fields are only implied (e.g. ingredients mentioned in a paragraph), infer them.
Do not return empty arrays or null fields — omit any field you cannot confidently extract.
