...
from datetime import streamlit as st
from firebase_admin import firestore
...
def create_suggestion(
    ...
    db.collection(COLLECTION).document(suggestion_id).set(payload)
...
def suggestion_input(field_name, current_value, document_type, document_id, user, context_mode="app_mode"):
...
def get_pending_suggestions():
    docs = db.collection(COLLECTION).where("status", "==", "pending") \
